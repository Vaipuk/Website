...
const LINKS = [
  {
    platform: 'Instagram',
    handle: '@vaipuk',
    url: 'https://instagram.com/vaipuk',
    variant: 'instagram',
    icon: '📸',
  },
  {
  ...
  return (
    <section className={styles.links}>
      <div className="container">
        <span ref={labelRef as React.RefObject<HTMLSpanElement>} className="section-label">Find me on</span>
          ...
          {LINKS.map((link, i) => {
            ...
            return (
              <a
                ...
                className={`${styles.card} ${styles[link.variant as keyof typeof styles]}`}
              >
                <div className={styles.cardIcon}>
                  {link.icon ?? iconMap[link.variant]}
                </div>
                <div className={styles.cardBottom}>
                  <div>
                    <span className={styles.cardName}>{link.platform}</span>
